DELIVERY_PARTNER = {
  ...
  h[:v4] = h[:v3].deep_dup
  h[:v4][:properties][:attributes][:properties].delete(:cohort)
  h[:v4][:properties][:attributes][:properties][:lead_providers] = {
    description: "The lead providers associated with the delivery partner.",
    type: :array,
    nullable: false,
    example: ["Lead Provider 1", "Lead Provider 2"],
  }
}.freeze
