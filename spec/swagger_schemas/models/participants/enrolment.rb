PARTICIPANT_ENROLMENT = {
  ...
  properties: {
    ...
    training_status: {
      description: "The training status of this participant",
      type: :string,
      example: "active",
    ...
    participant_status: {
      ...
      type: :string,
      enum: %w[active joining leaving left withdrawn],
      example: "active"
    },
    eligible_for_funding: {
    ...
    induction_end_date: {
      description: "The induction period end date",
      type: :string,
      format: "date",
      example: "2023-01-01",
      nullable: true
    ...
    mentor_ineligible_for_funding_reason: {
      ...
      type: :string,
      enum: Teacher.mentor_became_ineligible_for_funding_reasons.keys + %w[mentor_not_completed],
