RSpec.describe Events::Record do
  ...
  describe ".record_teacher_passes_induction_event!" do
    it "queues a RecordEventJob with the correct values" do
      freeze_time do
        Events::Record.record_teacher_passes_induction_event!(author:, teacher:, appropriate_body_period:, induction_period:, body: "Correcting an error")
    ...
    it "fails when induction period is missing" do
      expect {
        Events::Record.record_teacher_fails_induction_event!(author:, teacher:, appropriate_body_period:, induction_period: nil)
      }.to raise_error(Events::NoInductionPeriod)
    end
  end
  ...
  describe ".record_teacher_fails_induction_event!" do
    it "queues a RecordEventJob with the correct values" do
      freeze_time do
        Events::Record.record_teacher_fails_induction_event!(author:, teacher:, appropriate_body_period:, induction_period:, zendesk_ticket_id: "#123456")
