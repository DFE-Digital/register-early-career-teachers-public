RSpec.describe API::Schools::Query do
  ...
  describe "#schools" do
    ...
    it "returns all eligible schools" do
      ...
      school = FactoryBot.create(:school, :eligible, :with_metadata, contract_period:)
    ...
    context "when there is existing partnerships" do
      let(:contract_period) { FactoryBot.create(:contract_period) }
      let(:school1) { FactoryBot.create(:school, :eligible, :with_metadata, contract_period:) }
      let(:school2) { FactoryBot.create(:school, :ineligible, :with_metadata, contract_period:) }
    ...
    it "orders schools by `created_at` date in ascending order" do
      contract_period = FactoryBot.create(:contract_period)
      school1 = FactoryBot.create(:school, :eligible, :with_metadata, contract_period:, created_at: 2.days.ago)
      school2 = FactoryBot.create(:school, :eligible, :with_metadata, contract_period:, created_at: 1.day.ago)
      school3 = FactoryBot.create(:school, :eligible, :with_metadata, contract_period:, created_at: Time.zone.now)
    ...
    describe "filtering" do
      describe "by `contract_period_year`" do
        let!(:school1) { FactoryBot.create(:school, :eligible, :with_metadata, contract_period:) }
        let!(:school2) { FactoryBot.create(:school, :with_metadata, contract_period:) }
        let!(:school3) { FactoryBot.create(:school, :with_metadata, contract_period:) }
      ...
      describe "by `urn`" do
        let!(:school1) { FactoryBot.create(:school, :eligible, :with_metadata, contract_period:, urn: "1234567") }
        let!(:school2) { FactoryBot.create(:school, :eligible, :with_metadata, contract_period:, urn: "4567890") }
        let!(:contract_period) { FactoryBot.create(:contract_period) }
        let!(:urn) { school1.urn }
    ...
    describe "sorting" do
      ...
      let(:school1) { FactoryBot.create(:school, :eligible, :with_metadata, contract_period:, created_at: 1.day.ago) }
      let(:school2) { FactoryBot.create(:school, :eligible, :with_metadata, contract_period:, created_at: 2.days.ago) }
      let(:school3) { FactoryBot.create(:school, :eligible, :with_metadata, contract_period:, created_at: Time.zone.now) }
  ...
  describe "#school_by_api_id" do
    ...
    let(:school) { FactoryBot.create(:school, :eligible, :with_metadata, contract_period:) }
