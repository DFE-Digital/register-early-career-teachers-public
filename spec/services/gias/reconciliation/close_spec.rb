RSpec.describe GIAS::Reconciliation::Close do
  describe "#close" do
    ...
    let(:gias_school_can_be_closed_after_split?) { false }
    ...
    let(:eligibility) do
      instance_double(
        ...
        can_be_closed?: gias_school_can_be_closed?,
        can_be_closed_after_split?: gias_school_can_be_closed_after_split?
      )
    end
    ...
    context "when the school is being split" do
      ...
      let(:gias_school_can_be_closed_after_split?) { true }
