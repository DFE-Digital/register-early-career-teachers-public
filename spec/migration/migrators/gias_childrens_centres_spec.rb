describe Migrators::GIASChildrensCentres do
  ...
  it_behaves_like "a migrator", :gias_childrens_centres, [:gias_import], multiple_workers: false do
  ...
  describe "#migrate!" do
    let!(:data_migration) { FactoryBot.create(:data_migration, model: :gias_childrens_centres, worker: 0) }
