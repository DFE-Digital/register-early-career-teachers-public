describe Migrators::Statement do
  it_behaves_like "a migrator", :statement, %i[lead_provider registration_period] do
    ...
    def create_resource(migration_resource)
      lead_provider = FactoryBot.create(:lead_provider, name: migration_resource.lead_provider.name)
    ...
    def setup_failure_state
      ...
      FactoryBot.create(:lead_provider, name: migration_statement.lead_provider.name)
    end
