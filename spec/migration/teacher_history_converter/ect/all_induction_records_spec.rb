describe "All induction records mode conversion" do
  subject { TeacherHistoryConverter.new(ecf1_teacher_history:, migration_mode: :all_induction_records).convert_to_ecf2! }
...

  {
    ...
    ##### Not valid when we're ordering by start_date ASC
    ...
    ### not possible with ordering by start_date ASC
