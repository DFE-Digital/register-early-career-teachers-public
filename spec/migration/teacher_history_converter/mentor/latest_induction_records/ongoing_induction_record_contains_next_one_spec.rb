describe "Ongoing induction record contains next one" do
  ...
  # day, immediately before the ongoing one starts
  #
  #      ┌──────────────────────────────────────>
  #      │
  #      └──────────────────────────────────────>
  ...
  it "creates an ongoing mentor at school period that starts on the day the ongoing induction record started" do
    ...
    aggregate_failures do
      expect(ongoing_mentor_at_school_period.started_on).to eql(Date.new(2024, 3, 3))
      expect(ongoing_mentor_at_school_period.finished_on).to be_nil
    end
  end
