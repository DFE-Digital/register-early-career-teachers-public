...

  {
    ...
    context description do
      ...
      it "creates the right expected number of mentor at school periods" do
        expect(subject.mentor_at_school_period_rows.size).to eq(data[:at_school_periods].size)
      end
      ...
      it "produces the expected mentor at school periods" do
        aggregate_failures do
          data[:at_school_periods].each_with_index do |at_school_period, i|
            ...
            expect(subject.mentor_at_school_period_rows[i].started_on).to eql(started_on)
            expect(subject.mentor_at_school_period_rows[i].finished_on).to eql(finished_on)
            expect(subject.mentor_at_school_period_rows[i].school.urn).to eql(at_school_period[:urn])
          end
        end
      end
