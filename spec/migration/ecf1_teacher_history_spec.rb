        ...
        context "when the ect or mentor has more than two induction records" do
          ...
          it "populates the right attributes" do
            aggregate_failures "ECT induction records results" do
              ...
              expect(historic_record_1.school.urn).to eq(induction_record_1.induction_programme.school_cohort.school.urn)
              ...
              expect(historic_record_2.school.urn).to eq(induction_record_2.induction_programme.school_cohort.school.urn)
