RSpec.describe API::Documentation::Training::Guidance::SidebarComponent, type: :component do
  describe "initialization" do
    ...
    describe "#structure" do
      let(:current_path) { "/api/docs/training/guidance/guidance-for-lead-providers/beta-page" }
      ...
      it "returns nodes with correct attributes" do
        ...
        component.structure.each do |node|
          ...
          expect(node.href).to start_with("/api/docs/training/guidance/guidance-for-lead-providers/")
