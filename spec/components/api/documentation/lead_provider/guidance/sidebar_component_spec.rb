RSpec.describe API::Documentation::LeadProvider::Guidance::SidebarComponent, type: :component do
  describe "initialization" do
    ...
    describe "#structure" do
      let(:current_path) { "/api/docs/lead-provider/guidance/guidance-for-lead-providers/beta-page" }
      ...
      it "returns nodes with correct attributes" do
        ...
        component.structure.each do |node|
          ...
          expect(node.href).to start_with("/api/docs/lead-provider/guidance/guidance-for-lead-providers/")
