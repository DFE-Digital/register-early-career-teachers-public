RSpec.describe API::Documentation::LeadProvider::Guidance::ReleaseNotes::TagsComponent, type: :component do
  describe "TAG_MAPPINGS" do
    let(:tags) { described_class::TAG_MAPPINGS.keys.sort }

    it "maps all tags" do
      notes_file_path = Rails.root.join("app/views/api/documentation/lead_provider/release_notes/release_notes.yml")
