RSpec.describe Schools::SummaryCardComponent, type: :component do
  ...
  let(:available_provider_pairing) { FactoryBot.create(:available_provider_pairing, active_lead_provider:, delivery_partner:) }
  let(:school_partnership) { FactoryBot.create(:school_partnership, available_provider_pairing:) }
