RSpec.describe TasksIndex::TableSectionComponent, type: :component do
  ...
  context "with no ect_at_school_periods" do
    ...
    let(:row_component) { TasksIndex::NoQts::TableRowComponent }
  ...
  context "with Claimable::TableRowComponent" do
    let(:row_component) { TasksIndex::Claimable::TableRowComponent }
  ...
  context "with ClaimedByAnother::TableRowComponent" do
    let(:row_component) { TasksIndex::ClaimedByAnother::TableRowComponent }
