RSpec.describe Schools::RegisterECTWizard::LeadProviderStep, type: :model do
  describe 'validations' do
    ...
    context 'when the lead_provider_id is not present' do
      ...
      it 'is not valid' do
        ...
        expect(subject.errors[:lead_provider_id]).to include("Enter the name of the lead provider which will be supporting the ECT's induction")
      end
    end
