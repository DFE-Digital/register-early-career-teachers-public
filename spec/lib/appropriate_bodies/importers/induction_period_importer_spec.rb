describe AppropriateBodies::Importers::InductionPeriodImporter do
  ...
  let!(:ab_3) { FactoryBot.create(:appropriate_body_period, dqt_id: "ef1c5e56-a8e6-41e2-a47d-c75a098cd61f") }
  let!(:ab_4) { FactoryBot.create(:appropriate_body_period, dqt_id: "67fc4692-2b90-4a80-8131-795eb93bc496") }
  let!(:ab_5) { FactoryBot.create(:appropriate_body_period, dqt_id: "f4837bce-28ae-46d0-aae7-d49f1d8f62e3") }
