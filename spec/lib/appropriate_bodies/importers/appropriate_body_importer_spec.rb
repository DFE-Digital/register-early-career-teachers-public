describe AppropriateBodies::Importers::AppropriateBodyImporter do
  ...
  #       expect(subject.rows[0].local_authority_code).to be(123)
  #     end
  #   end
  ...
  #       expect(subject.rows[0].establishment_number).to be(1234)
  #     end
  #   end

  #   context "when the appropriate body legacy_id is in the list of wanted_legacy_ids" do
  #     it "parses and builds the rows" do
  #       expect(subject.rows.map(&:dqt_id)).to match_array(wanted_legacy_ids)
  #     end
  #   end
  ...
  #       parsed_legacy_ids = subject.rows.map(&:dqt_id)
  ...
  #       expect(subject.rows[0].local_authority_code).to be(567)
  #     end
  #   end
