      ...
      context "when there are ECT/mentor training periods for the lead provider" do
        ...
        describe "ECT enrolment" do
          ...
          it "serializes `created_at`" do
            expect(ect_enrolment["created_at"]).to eq(ect_training_period.trainee.created_at.utc.rfc3339)
          end
        ...
        describe "mentor enrolment" do
          ...
          it "serializes `created_at`" do
            expect(mentor_enrolment["created_at"]).to eq(mentor_training_period.trainee.created_at.utc.rfc3339)
          end
