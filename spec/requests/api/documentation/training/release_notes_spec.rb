RSpec.describe "Release Notes" do
  ...
  describe "GET /api/docs/training/release-notes/:slug" do
    let(:notes_file_path) { Rails.root.join("app/views/api/documentation/training/release_notes/release_notes.yml") }
