RSpec.describe "Release Notes" do
  describe "GET /api/docs/lead-provider/release-notes" do
  ...
  describe "GET /api/docs/lead-provider/release-notes/:slug" do
    let(:notes_file_path) { Rails.root.join("app/views/api/documentation/lead_provider/release_notes/release_notes.yml") }
