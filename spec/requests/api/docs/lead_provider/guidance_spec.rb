RSpec.describe "API Guidance pages" do
  describe "GET /api/docs/lead-provider/guidance" do
  ...
  describe "GET /api/guidance/swagger-api-documentation" do
    ...
    it "redirects to the Swagger UI page" do
      expect(response).to redirect_to("/api/docs/lead-provider/v3")
    end
  end

  describe "GET /api/docs/lead-provider/guidance-for-lead-providers/sandbox" do
  ...
  describe "GET /api/docs/lead-provider/guidance-for-lead-providers" do
