RSpec.describe "Admin finance framework agreement contracts", type: :request do
  ...
  let(:contract_path) { admin_contract_period_framework_agreement_contract_path(contract_period, framework_agreement, contract) }
  let(:contracts_path) { admin_contract_period_framework_agreement_contracts_path(contract_period, framework_agreement) }
  let(:new_path) { new_admin_contract_period_framework_agreement_contract_path(contract_period, framework_agreement) }
  let(:edit_path) { edit_admin_contract_period_framework_agreement_contract_path(contract_period, framework_agreement, contract) }
  let(:delete_path) { delete_admin_contract_period_framework_agreement_contract_path(contract_period, framework_agreement, contract) }
