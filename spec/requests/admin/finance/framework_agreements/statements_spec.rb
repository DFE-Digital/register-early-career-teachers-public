RSpec.describe "Admin finance active lead provider statements", type: :request do
  ...
  let(:index_path) { admin_contract_period_framework_agreement_statements_path(contract_period, framework_agreement) }
  let(:new_path) { new_admin_contract_period_framework_agreement_statement_path(contract_period, framework_agreement) }
  ...
  let(:edit_path) { edit_admin_contract_period_framework_agreement_statement_path(contract_period, framework_agreement, statement) }
  let(:delete_path) { delete_admin_contract_period_framework_agreement_statement_path(contract_period, framework_agreement, statement) }
  ...
  describe "GET .../statements" do
    ...
    context "when signed in as a finance DfE user" do
      ...
      it "displays the active lead provider's statements" do
        ...
        expect(response.body).to include(admin_contract_period_framework_agreements_path(contract_period))
      end
    end
  end
  ...
  describe "POST .../statements" do
    ...
    context "when signed in as a finance DfE user" do
      ...
      it "creates a statement and redirects to it" do
        ...
        expect(response).to redirect_to(admin_contract_period_framework_agreement_statement_path(contract_period, framework_agreement, statement))
