RSpec.describe "Admin delivery partners", type: :request do
  describe "GET /admin/organisations/delivery-partners" do
    it "redirects to sign in path" do
      get "/admin/organisations/delivery-partners"
    ...
    context "with an authenticated DfE user" do
      ...
      context "with search query" do
        ...
        it "filters delivery partners by name" do
          get "/admin/organisations/delivery-partners", params: { q: "Test Delivery" }
      ...
      context "when delivery partners exist" do
        ...
        it "shows search empty state when search returns no results" do
          get "/admin/organisations/delivery-partners", params: { q: "nonexistent" }
      ...
      it "shows empty state when no delivery partners exist" do
        get "/admin/organisations/delivery-partners"
  ...
  describe "GET /admin/organisations/delivery-partners/:id" do
    ...
    it "redirects to sign in path" do
      get "/admin/organisations/delivery-partners/#{delivery_partner.id}"
      expect(response).to redirect_to(sign_in_path)
    end
