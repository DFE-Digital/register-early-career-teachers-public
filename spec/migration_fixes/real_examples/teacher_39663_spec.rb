describe "Real data check for teacher 39663" do
  let!(:teacher) { FactoryBot.create(:teacher, id: 39663) }
  ...
  let!(:school_partnership_1) { FactoryBot.create(:school_partnership, id: 58227, school: school_1, lead_provider_delivery_partnership: lpdp_1) }
  ...
  let!(:training_period_1) { FactoryBot.create(:training_period, id: 135514, school_partnership: school_partnership_1, ect_at_school_period: ect_at_school_period_1, mentor_at_school_period: nil, started_on: Date.new(2023, 6, 1), finished_on: Date.new(2025, 7, 23), training_programme: "provider_led", withdrawn_at: nil, withdrawal_reason: nil, deferred_at: nil, deferral_reason: nil) }
  ...
  it "updates the record correctly" do
    ...
    expect(training_period_1.withdrawal_reason).to be_moved_school
  end
end
