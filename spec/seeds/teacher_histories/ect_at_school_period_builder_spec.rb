describe TeacherHistories::ECTAtSchoolPeriodBuilder do
  let(:trn) { "1122334" }
  ...
  describe "adding training periods" do
    ...
    it "adds a training periods to the ECT at school period" do
    ...
    context "when ongoing" do
      let(:teacher) do
        ...
        TeacherHistories::TeacherBuilder.teacher(trn, full_name) do
          ect_at_school_period(school_inner, "2024-01-01") do
