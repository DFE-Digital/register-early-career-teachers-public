RSpec.describe "Assigning a new induction tutor", :enable_schools_interface do
  ...
  def then_i_am_taken_to_the_new_induction_tutor_page
    expect(page).to have_path("/school/new-induction-tutor/edit")
  ...
  def then_i_should_be_taken_to_the_confirmation_page
    expect(page).to have_path("/school/new-induction-tutor/confirmation")
  end
  ...
  def then_i_should_be_taken_to_the_check_answers_page
    expect(page).to have_path("/school/new-induction-tutor/check-answers")
  end
