...
private
  ...
  def and_there_is_a_contract_period
    @closed_contract_period = FactoryBot.create(:contract_period, :with_schedules, year: 2021)
  end

  def and_the_contract_period_is_closed
    @closed_contract_period.update!(payments_frozen_at: 1.day.ago)
  end
