RSpec.describe 'Registering an ECT' do
  ...
  scenario 'User enters national insurance number but teacher has failed their induction' do
    ...
    when_i_enter_a_matching_national_insurance_number_but_the_teacher_has_failed_their_induction
  ...
  def when_i_enter_a_matching_national_insurance_number_but_the_teacher_has_failed_their_induction
