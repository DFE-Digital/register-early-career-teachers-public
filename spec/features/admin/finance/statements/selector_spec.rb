RSpec.describe "Admin finance statement selector" do
  ...
  def given_statement_exist_with_dropdown_options
    ...
    @statement1 = FactoryBot.create(:statement, framework_agreement: @framework_agreement1, year: 2024, month: 7)

    @lead_provider2 = FactoryBot.create(:lead_provider)
    @contract_period2 = FactoryBot.create(:contract_period)
    @framework_agreement2 = FactoryBot.create(:framework_agreement, lead_provider: @lead_provider2, contract_period: @contract_period2)
    @statement2 = FactoryBot.create(:statement, framework_agreement: @framework_agreement2, year: 2025, month: 5)
  end
