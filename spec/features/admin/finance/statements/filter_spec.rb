RSpec.describe "Admin finance statement filter" do
  ...
  def given_statements_exist
    ...
    @framework_agreement1 = FactoryBot.create(:framework_agreement, lead_provider: @lead_provider1, contract_period: @contract_period1)
    @framework_agreement2 = FactoryBot.create(:framework_agreement, lead_provider: @lead_provider1, contract_period: @contract_period2)
    @framework_agreement3 = FactoryBot.create(:framework_agreement, lead_provider: @lead_provider2, contract_period: @contract_period2)

    @statement1 = FactoryBot.create(:statement, framework_agreement: @framework_agreement1, fee_type: "output", year: 2025, month: 5)
    @statement2 = FactoryBot.create(:statement, framework_agreement: @framework_agreement1, fee_type: "service", year: 2023, month: 5)

    @statement3 = FactoryBot.create(:statement, framework_agreement: @framework_agreement2, fee_type: "output", year: 2022, month: 5)
    @statement4 = FactoryBot.create(:statement, framework_agreement: @framework_agreement2, fee_type: "service", year: 2024, month: 5)

    @statement5 = FactoryBot.create(:statement, framework_agreement: @framework_agreement3, fee_type: "output", year: 2025, month: 8)
    @statement6 = FactoryBot.create(:statement, framework_agreement: @framework_agreement3, fee_type: "service", year: 2026, month: 8)
  end
