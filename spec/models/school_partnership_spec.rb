...
ActiveRecord::Schema[8.0].define(version: 20_250_415_164_717) do
  ...
  create_enum "mentor_completion_reason", %w[completed_declaration_received completed_during_early_roll_out started_not_completed]
  ...
  create_table "ect_at_school_periods", force: :cascade do |t|
    ...
    t.index %w[lead_provider_id], name: "index_ect_at_school_periods_on_lead_provider_id"
  ...
  create_table "events", force: :cascade do |t|
    ...
    t.index %w[provider_partnership_id], name: "index_events_on_provider_partnership_id"
  ...
  create_table "provider_partnerships", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index %w[delivery_partner_id], name: "index_provider_partnerships_on_delivery_partner_id"
    t.index %w[lead_provider_id], name: "index_provider_partnerships_on_lead_provider_id"
    t.index %w[registration_period_id lead_provider_id delivery_partner_id], name: "yearly_unique_provider_partnerships", unique: true
    t.index %w[registration_period_id], name: "index_provider_partnerships_on_registration_period_id"
  end
  ...
  create_table "registration_periods", primary_key: "year", id: :serial, force: :cascade do |t|
    ...
    t.virtual "range", type: :daterange, as: "daterange(started_on, finished_on)", stored: true
    t.index %w[year], name: "index_registration_periods_on_year", unique: true
  end
  ...
  create_table "schools", force: :cascade do |t|
    ...
    t.index %w[chosen_appropriate_body_id], name: "index_schools_on_chosen_appropriate_body_id"
    t.index %w[chosen_lead_provider_id], name: "index_schools_on_chosen_lead_provider_id"
  ...
  create_table "training_periods", force: :cascade do |t|
    ...
    t.index %w[provider_partnership_id ect_at_school_period_id mentor_at_school_period_id started_on], name: "provider_partnership_trainings", unique: true
    t.index %w[provider_partnership_id], name: "index_training_periods_on_provider_partnership_id"
  end
