      ...
      context 'when school-led' do
        ...
        context 'when expression of interest is present' do
          ...
          it 'has an error on expression_of_interest' do
            subject.valid?
            expect(subject.errors.messages[:expression_of_interest]).to include('must be absent for school-led training programmes')
          end
        end
        ...
        context 'when school partnership is present' do
          ...
          it 'has an error on school_partnership' do
            subject.valid?
            expect(subject.errors.messages[:school_partnership]).to include('must be absent for school-led training programmes')
          end
        end
