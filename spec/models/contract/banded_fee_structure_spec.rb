RSpec.describe Contract::BandedFeeStructure, type: :model do
  describe "associations" do
    ...
    it { is_expected.to have_many(:terms).order(min_declarations: :asc).class_name("Contract::BandedFeeStructure::BandTerm").inverse_of(:banded_fee_structure).dependent(:destroy) }
