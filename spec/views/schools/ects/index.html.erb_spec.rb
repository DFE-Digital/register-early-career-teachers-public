RSpec.describe 'schools/ects/index.html.erb' do
  ...
  context 'when there are teachers' do
    ...
    let!(:ect_at_school_period) { FactoryBot.create(:ect_at_school_period, :active, teacher:, school:) }
    let!(:training_period) { FactoryBot.create(:training_period, :active, ect_at_school_period:) }
