RSpec.describe "admin/finance/active_lead_providers/contracts/show.html.erb" do
  ...
  before do
    ...
    assign(:breadcrumbs, {
      ...
      "Contracts" => admin_contract_period_active_lead_provider_contracts_path(contract_period, framework_agreement),
    })
  end
  ...
  it "renders the title, breadcrumbs and contract details" do
    ...
    expect(view.content_for(:backlink_or_breadcrumb)).to have_link("Contracts", href: admin_contract_period_active_lead_provider_contracts_path(contract_period, framework_agreement))
