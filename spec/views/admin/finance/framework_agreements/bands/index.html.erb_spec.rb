RSpec.describe "admin/finance/framework_agreements/bands/index.html.erb" do
  ...
  before do
    ...
    assign(:breadcrumbs, {
      ...
      framework_agreement.lead_provider_name => admin_contract_period_framework_agreement_bands_path(contract_period, framework_agreement),
    })
  end
  ...
  it "renders the title, breadcrumbs, description and contracts table" do
    ...
    expect(view.content_for(:backlink_or_breadcrumb)).to have_link(framework_agreement.lead_provider_name, href: admin_contract_period_framework_agreement_bands_path(contract_period, framework_agreement))
    ...
    expect(rendered).to have_link(
      "Change Band B",
      href: edit_admin_contract_period_framework_agreement_band_path(contract_period, framework_agreement, band_b)
    )
  end
