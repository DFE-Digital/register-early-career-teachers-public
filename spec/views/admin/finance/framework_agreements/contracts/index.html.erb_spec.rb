RSpec.describe "admin/finance/framework_agreements/contracts/index.html.erb" do
  ...
  it "renders the title, breadcrumbs, description and contracts table" do
    ...
    expect(rendered).to have_link(
      ...
      href: admin_contract_period_framework_agreement_contract_path(contract_period, framework_agreement, contract)
    )
  end
