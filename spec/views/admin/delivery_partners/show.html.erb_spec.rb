RSpec.describe 'admin/delivery_partners/show.html.erb' do
  ...
  it 'includes backlink with preserved page and query parameters' do
    ...
    expect(view.content_for(:backlink_or_breadcrumb)).to have_link('Back', href: '/admin/organisations/delivery-partners?page=2&q=search+term')
  end
  ...
  context 'when page parameters are nil' do
    ...
    it 'still renders backlink without parameters' do
      ...
      expect(view.content_for(:backlink_or_breadcrumb)).to have_link('Back', href: '/admin/organisations/delivery-partners')
    end
  end
end
