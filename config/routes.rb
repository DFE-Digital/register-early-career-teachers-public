Rails.application.routes.draw do
  ...
  namespace :admin do
    ...
    resources :teachers, only: %i[index show] do
      ...
      scope module: :teachers do
        resource :timeline, only: %i[show], controller: :timeline
        ...
        resource :reopen_induction, only: %i[update], path: 'reopen-induction', controller: :reopen_induction
    ...
    namespace :import_ect, path: 'import-ect' do
      ...
      namespace :errors do
        get 'induction-already-completed/:id', to: 'induction_already_completed', as: 'already_complete'
        get 'no-qts/:id', to: 'no_qts', as: 'no_qts'
        get 'prohibited-from-teaching/:id', to: 'prohibited_from_teaching', as: 'prohibited'
      end
    end
  ...
  namespace :appropriate_bodies, path: 'appropriate-body', as: :ab do
    ...
    namespace :claim_an_ect, path: 'claim-an-ect' do
      ...
      namespace :errors do
        get 'induction-already-completed/:id', to: 'induction_already_completed', as: 'already_complete'
        get 'induction-with-another-appropriate-body/:id', to: 'induction_with_another_appropriate_body', as: 'another_ab'
        get 'no-qts/:id', to: 'no_qts', as: 'no_qts'
        get 'prohibited-from-teaching/:id', to: 'prohibited_from_teaching', as: 'prohibited'
      end
    end
