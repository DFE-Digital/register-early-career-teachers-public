...
We hope this will make it easier for lead providers and appropriate bodies to support schools with the transition between the existing services to Manage early career teacher training and the new Register ECTs service. 

All of these changes have been tested in research with schools. 

## Using DfE Sign in to access the service 

### Using DfE sign in

Schools will now use DfE Sign in to access the Register ECTs service. 
...
As part of using DfE Sign in, multiple people working for a school can now gain access to the Register ECTs service. Previously, only 1 person could be nominated as the school induction tutor and access the service. 
...
In Register ECTs, when a school registers an ECT or mentor, they only provide the: 
...
If the TRN and date of birth are correct, we will show them the name of the ECT or mentor to confirm. 

If they are incorrect, we ask for the national insurance number. If this is also incorrect or not provided, they will not be able to progress with registering the ECT or mentor. 

If the name is out of date or is spelt wrong, the school may correct it. However, they must not do this to name a different person. Schools must only correct spelling or update legal name changes. 
...
When an early career teacher is being registered on the new service, we ask schools some additional questions. These are outlined below. 

### Schools need to tell us the ECT’s working pattern 

This question specifically wants to know their working pattern as an ECT. 
...
- are only allowed to view and select one appropriate body for all of their ECTs 
- can only see one lead provider and delivery partner for all of their ECTs and mentors 

This is the case even when their ECTs and mentors may be training with different lead providers or delivery partners.
...
Schools can now change the following information about their ECTs after they are registered, but before they have completed induction:
...
In the existing services, schools could only tell us when an ECT or mentor was leaving to move to another school. Now, schools can tell us when an ECT or mentor is leaving and not expected to return for any reason.
