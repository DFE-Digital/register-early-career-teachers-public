...
begin
  ...
  csv_log << %w[training_period_id original_started_on original_finished_on original_deferred_at original_deferral_reason original_withdrawn_at original_withdrawal_reason deferred_at deferral_reason errors]
  ...
  CSV.foreach(csv_file, headers: true, header_converters: :symbol) do |row|
    ...
    csv_log << [training_period.id, training_period.started_on, training_period.finished_on, training_period.deferred_at, training_period.deferral_reason, training_period.withdrawn_at, training_period.withdrawal_reason, deferred_at, deferral_reason, nil]
