...
def describe_training_period(tp)
  ...
  if tp.provider_led_training_programme? && tp.school_partnership.present?
  ...
  elsif tp.provider_led_training_programme? && tp.expression_of_interest.present?
    suffix = "(training period - provider-led)"
  ...
  elsif tp.school_led_training_programme?
...
ambition_artisan_partnership_2021 = find_school_partnership(
...
FactoryBot.create(:training_period,
  ...
  started_on: Date.new(2021, 9, 1),
  finished_on: nil,
  school_partnership: ambition_artisan_partnership_2021,
  training_programme: "provider_led").tap { |tp| describe_training_period(tp) }
...
FactoryBot.create(:training_period,
  ...
  started_on: Date.new(2021, 9, 1),
  finished_on: nil,
  school_partnership: teach_first_grain_partnership_2021,
  training_programme: "provider_led").tap { |tp| describe_training_period(tp) }
