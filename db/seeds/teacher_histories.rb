...
FactoryBot.create(:training_period,
                  ...
                  started_on: emma_thompson_mentoring_at_abbey_grove.started_on,
...
FactoryBot.create(:training_period,
                  ...
                  started_on: kate_winslet_ect_at_ackley_bridge.started_on,
                  finished_on: kate_winslet_ect_at_ackley_bridge.finished_on,
...
FactoryBot.create(:training_period,
                  ...
                  started_on: hugh_laurie_mentoring_at_abbey_grove.started_on,
                  finished_on: hugh_laurie_mentoring_at_abbey_grove.finished_on,
...
FactoryBot.create(:training_period,
                  ...
                  started_on: alan_rickman_ect_at_ackley_bridge.started_on,
                  finished_on: alan_rickman_ect_at_ackley_bridge.finished_on,
                  school_partnership: teach_first_grain_partnership_2022,
                  training_programme: 'provider_led').tap { |tp| describe_training_period(tp) }
...
FactoryBot.create(:training_period,
                  ...
                  started_on: hugh_grant_ect_at_abbey_grove.started_on,
                  finished_on: nil,
                  expression_of_interest: nil,
                  school_partnership: nil,
                  training_programme: 'school_led').tap { |tp| describe_training_period(tp) }
...
FactoryBot.create(:training_period,
                  ...
                  started_on: colin_firth_ect_at_abbey_grove.started_on,
                  finished_on: nil,
                  school_partnership: ambition_artisan_partnership_2022,
                  training_programme: 'provider_led').tap { |tp| describe_training_period(tp) }
...
FactoryBot.create(:training_period,
                  ...
                  started_on: imogen_stubbs_at_malory_towers.started_on,
                  finished_on: nil,
                  school_partnership: teach_first_grain_partnership_2022,
                  training_programme: 'provider_led').tap { |tp| describe_training_period(tp) }
...
FactoryBot.create(:training_period,
                  ...
                  started_on: gemma_jones_at_malory_towers.started_on,
                  finished_on: nil,
                  school_partnership: teach_first_grain_partnership_2022,
                  training_programme: 'provider_led').tap { |tp| describe_training_period(tp) }
...
FactoryBot.create(:training_period,
                  ...
                  started_on: anthony_hopkins_ect_at_brookfield_school.started_on,
                  finished_on: nil,
                  school_partnership: teach_first_grain_partnership_2022,
                  training_programme: 'provider_led').tap { |tp| describe_training_period(tp) }
...
FactoryBot.create(:training_period,
                  ...
                  started_on: stephen_fry_ect_at_brookfield_school.started_on,
                  finished_on: nil,
                  school_partnership: teach_first_grain_partnership_2022,
                  training_programme: 'provider_led').tap { |tp| describe_training_period(tp) }
...
FactoryBot.create(:training_period,
                  ...
                  started_on: harriet_walter_ect_at_brookfield_school.started_on,
                  finished_on: nil,
                  school_partnership: teach_first_grain_partnership_2022,
                  training_programme: 'provider_led').tap { |tp| describe_training_period(tp) }
...
FactoryBot.create(:training_period,
                  ...
                  started_on: helen_mirren_mentoring_at_brookfield_school.started_on,
                  finished_on: nil,
                  school_partnership: teach_first_grain_partnership_2022,
                  training_programme: 'provider_led').tap { |tp| describe_training_period(tp) }
...
FactoryBot.create(:training_period,
                  ...
                  started_on: john_withers_mentoring_at_abbey_grove.started_on,
                  finished_on: nil,
                  school_partnership: teach_first_grain_partnership_2022,
                  training_programme: 'provider_led').tap { |tp| describe_training_period(tp) }
...
FactoryBot.create(:training_period,
                  ...
                  started_on: dominic_west_ect_at_brookfield_school.started_on,
                  finished_on: nil,
...
FactoryBot.create(:training_period,
                  ...
                  started_on: peter_davison_at_abbey_grove_school.started_on,
                  finished_on: nil,
...
FactoryBot.create(:mentorship_period,
                  ...
                  started_on: hugh_grant_ect_at_abbey_grove.started_on,
                  finished_on: hugh_grant_ect_at_abbey_grove.started_on + 1.year).tap { |mp| describe_mentorship_period(mp) }
