...
AppropriateBody.create!(name: AppropriateBody::ISTIP, local_authority_code: 50, dfe_sign_in_organisation_id: "203606a4-4199-46a9-84e4-56fbc5da2a36", dqt_id: "6ae042bb-c7ae-e311-b8ed-005056822391", type: 'national')
AppropriateBody.create!(type: 'teaching_school_hub', name: 'Canvas Teaching School Hub', local_authority_code: 109, establishment_number: 2367)
south_yorkshire_studio_hub = AppropriateBody.create!(type: 'teaching_school_hub', name: 'South Yorkshire Studio Hub', local_authority_code: 678, establishment_number: 9728)
AppropriateBody.create!(type: 'teaching_school_hub', name: 'Ochre Education Partnership', local_authority_code: 238, establishment_number: 6582)
umber_teaching_school_hub = AppropriateBody.create!(type: 'teaching_school_hub', name: 'Umber Teaching School Hub', local_authority_code: 957, establishment_number: 7361, dfe_sign_in_organisation_id: 'd245ec79-534e-4547-a7e4-ccd98803b627')
golden_leaf_teaching_school_hub = AppropriateBody.create!(type: 'teaching_school_hub', name: 'Golden Leaf Teaching School Hub', local_authority_code: 648, establishment_number: 3986)
AppropriateBody.create!(type: 'teaching_school_hub', name: 'Frame University London', local_authority_code: 832, establishment_number: 6864)
AppropriateBody.create!(type: 'teaching_school_hub', name: 'Easelcroft Teaching School Hub', local_authority_code: 573, establishment_number: 9273)
AppropriateBody.create!(type: 'teaching_school_hub', name: 'Vista College', local_authority_code: 418, establishment_number: 3735)
