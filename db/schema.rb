...
ActiveRecord::Schema[8.0].define(version: 2025_09_23_104325) do
  ...
  create_table "teachers", force: :cascade do |t|
    ...
    t.datetime "api_ect_training_record_created_at"
    t.datetime "api_mentor_training_record_created_at"
