module AppropriateBodies::Importers
  ...
  private
    ...
    # @return [Hash{String => Integer}] All teachers (including newly imported)
    ...
    # @return [Hash{String => String}] All teachers (including newly imported)
    ...
    def finalised_rows
      ...
      teachers_with_inductions.slice(*teachers.trns).each do |trn, induction_periods|
        ...
        induction_periods.max_by(&:finished_on).induction_status = teacher_trn_to_status.fetch(trn)
      end
