    ...
    class TrainingPeriods
      ...
      def build
        ...
        training_period_data.each do |period|
          ...
          training_period.schedule = Schedules::Find.new(period: mentor_at_school_period, training_programme: period.training_programme, started_on: period.start_date).call
