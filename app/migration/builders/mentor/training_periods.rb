    ...
    class TrainingPeriods
      ...
      def build
        ...
        training_period_data.each do |period|
          ...
          registration_period_id = period.cohort_year

          provider_partnership = ::ProviderPartnership.find_by(lead_provider:, delivery_partner:, registration_period_id:)
          expression_of_interest = ::LeadProviderActivePeriod.find_by!(lead_provider:, registration_period_id:)
