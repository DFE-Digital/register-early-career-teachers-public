  ...
  class AttributesSerializer < Blueprinter::Base
    ...
    class << self
      ...
      def expressions_of_interest?(school, options)
        ...
        school.ect_at_school_periods.with_expressions_of_interest_for_lead_provider_and_contract_period(options[:contract_period_year], options[:lead_provider]&.id).exists? ||
          school.mentor_at_school_periods.with_expressions_of_interest_for_lead_provider_and_contract_period(options[:contract_period_year], options[:lead_provider]&.id).exists?
      end
    end
  end
