module Events
  ...
  class Record
    ...
    def self.record_mentor_lead_provider_updated_event!(old_lead_provider_name:, new_lead_provider_name:, author:, mentor_at_school_period:, school:, teacher:, happened_at:)
      event_type = :mentor_lead_provider_updated
      heading = TransitionDescription.for(
        "lead provider",
        from: old_lead_provider_name,
        to: new_lead_provider_name
      ...
      new(event_type:, author:, heading:, mentor_at_school_period:, school:, teacher:, happened_at:).record_event!
    end
