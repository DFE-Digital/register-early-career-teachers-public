module Events
  ...
  class Record
    ...
    def self.record_teacher_email_changed_event!(old_email:, new_email:, author:, ect_at_school_period:, school:, teacher:, happened_at:)
      event_type = :teacher_email_address_changed
