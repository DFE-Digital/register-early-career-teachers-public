module Events
  ...
  class Record
    ...
    def self.record_teacher_passes_induction_event!(author:, appropriate_body_period:, induction_period:, teacher:, body: nil, zendesk_ticket_id: nil)
      fail(NoInductionPeriod) unless induction_period
      ...
      new(event_type:, author:, appropriate_body_period:, teacher:, induction_period:, heading:, happened_at:, body:, zendesk_ticket_id:).record_event!
    end

    def self.record_teacher_fails_induction_event!(author:, appropriate_body_period:, induction_period:, teacher:, body: nil, zendesk_ticket_id: nil)
      fail(NoInductionPeriod) unless induction_period
