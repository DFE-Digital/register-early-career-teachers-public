module SandboxSeedData
  class APITeachers < Base
    ...
    def plant
      ...
      log_plant_info("api teachers")

      grouped_active_lead_providers.find_all do |_, active_lead_providers|
        active_lead_providers.each do |active_lead_provider|
          (NUMBER_OF_RECORDS / active_lead_providers.size).times do
  ...
  private
    ...
    def grouped_active_lead_providers
