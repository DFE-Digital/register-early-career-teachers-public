module Statements
  class Query
    ...
    def initialize(lead_provider: :ignore, registration_period_years: :ignore, updated_since: :ignore, state: :ignore, output_fee: true, statement_date: :ignore, order_by: :payment_date)
