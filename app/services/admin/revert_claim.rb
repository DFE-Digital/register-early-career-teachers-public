module Admin
    ...
    def revert_claim
      ActiveRecord::Base.transaction do
        ...
        if teacher.induction_periods.count.zero?
          ...
          record_teacher_induction_status_reset_on_trs_event!
        end
      end
    end
  ...
  private
    ...
    def record_teacher_induction_status_reset_on_trs_event!
      Events::Record.record_teacher_induction_status_reset_on_trs_event!(
        author:,
        appropriate_body:,
        teacher:
      )
