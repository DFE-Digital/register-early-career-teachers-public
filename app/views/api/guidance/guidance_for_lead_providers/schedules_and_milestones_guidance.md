...
| Concept | Definition |
| ------- | ---------- |
| Milestone | Contractual retention periods during which providers must submit relevant declarations evidencing training delivery and participant retention. These are used in the delivery of ECF training programme, in 2024 cohorts and earlier. |
| Milestone dates | The deadline date a valid declaration can be made for a given milestone in order for DfE to be liable to make a payment the following month. Milestone dates are dependent on the participant's schedule. These are used in the delivery of ECF training programme, in 2024 cohorts and earlier. |
| Milestone period | The period of time between the milestone start date and deadline date. These are used in the delivery of ECF training programme, in 2024 cohorts and earlier. This period is also referred to as a declaration window for ECTP, in the 2025 cohort or later. |
| Schedule | Schedules are timed sequences of expected participant engagement and payment points.<br><br>These are set when new early career teachers or mentors are registered, based on when they are starting at a school, when they're registered, and if they're a replacement mentor.<br><br>They are then updated and corrected by lead providers via the API.<br><br>Schedules also give DfE information about how participants are being trained. |
...
| --------- | ---------- | -------------------- | ---------------- | ------------ |
| Participant Start | 1 Jun 2025 | 31 Oct 2025 (interim) <br><br>31 Dec 2025 | started<br><br>started | 30 Nov 2025<br><br>31 Jan 2026 |
