...
Read our guidance on [schedules and milestones](/api/docs/lead-provider/guidance-for-lead-providers/schedules-and-milestones-guidance).  
...
Other fields are used to indicate that ECTs and mentors have completed induction or are not eligible for further funding. 
