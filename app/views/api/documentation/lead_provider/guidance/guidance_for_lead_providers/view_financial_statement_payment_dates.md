...
This endpoint is also useful when [identifying which cohorts participants have moved between](/api/docs/lead-provider/guidance-for-lead-providers/how-cohort-closures-and-changes-work#identifying-ects-who-we-39-ve-moved-to-the-2024-cohort).
