...
Read our [guidance on keeping data in sync](/api/docs/training/guidance-for-lead-providers/keeping-data-in-sync).
...
[View more information on declaration states](/api/docs/training/guidance-for-lead-providers/understanding-declarations).
