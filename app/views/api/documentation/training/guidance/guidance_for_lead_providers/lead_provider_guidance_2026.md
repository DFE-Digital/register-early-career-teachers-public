...
Lead providers can find out more about partnerships in our [create view and update partnership guidance](https://www.register-early-career-teachers.education.gov.uk/api/docs/training/guidance-for-lead-providers/create-view-and-update-partnerships) 
