class PendingInductionSubmissionBatch < ApplicationRecord
  ...
  def self.new_claim_for(appropriate_body_period:, **)
    new(appropriate_body_period:, batch_type: "claim", **)
  end

  # @return [PendingInductionSubmissionBatch] type "action"
  def self.new_action_for(appropriate_body_period:, **)
    new(appropriate_body_period:, batch_type: "action", **)
  end
  ...
  # Validations
  validates :appropriate_body_period, presence: true
