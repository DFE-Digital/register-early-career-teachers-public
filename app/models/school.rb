class School < ApplicationRecord
  ...
  belongs_to :induction_tutor_last_nominated_in_year, class_name: "ContractPeriod", primary_key: "year", foreign_key: "induction_tutor_last_nominated_in_year", optional: true
