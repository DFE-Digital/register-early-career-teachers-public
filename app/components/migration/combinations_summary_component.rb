class Migration::CombinationsSummaryComponent < Migration::BaseComponent
  ...
  def number_of_ect_combinations_processed = totals.total_ecf1_ect_combinations
  def number_of_successful_ect_combinations = totals.total_ecf2_ect_combinations
  ...
  def number_of_mentor_combinations_processed = totals.total_ecf1_mentor_combinations
  def number_of_successful_mentor_combinations = totals.total_ecf2_mentor_combinations
  ...
  def rate_of_successful_combinations = calculate_hit_rate(total_number_of_successful_combinations, total_number_of_missing_combinations)
end
