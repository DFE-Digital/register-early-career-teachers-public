module TasksIndex
  class DetailedReviewSectionComponent < ApplicationComponent
    ...
    delegate :unclaimed_ect_at_school_periods, :claimed_ect_at_school_periods, to: :appropriate_body_period, allow_nil: true
    ...
    delegate :marked_as_leaving_without_ongoing_period_at_same_appropriate_body, to: :claimed_ect_at_school_periods, allow_nil: true
    ...
    delegate :count, to: :marked_as_leaving_without_ongoing_period_at_same_appropriate_body, prefix: true
    ...
    alias_method :number_of_releasable_ect_records, :marked_as_leaving_without_ongoing_period_at_same_appropriate_body_count
