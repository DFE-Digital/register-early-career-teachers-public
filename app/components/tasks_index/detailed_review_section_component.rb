module TasksIndex
  class DetailedReviewSectionComponent < ApplicationComponent
    ...
    delegate :marked_as_leaving, to: :claimed_ect_at_school_periods, allow_nil: true
    ...
    delegate :count, to: :marked_as_leaving, prefix: true
    ...
    alias_method :number_of_releasable_ect_records, :marked_as_leaving_count
