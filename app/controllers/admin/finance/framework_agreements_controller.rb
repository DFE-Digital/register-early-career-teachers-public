module Admin::Finance
  class FrameworkAgreementsController < Admin::Finance::BaseController
    layout "full"
    ...
    def create
      @framework_agreement = ::FrameworkAgreements::Create.new(
        author: current_user,
      ...
      if @framework_agreement.persisted?
        ...
        redirect_to admin_contract_period_framework_agreements_path(@contract_period)
      else
        @available_lead_providers = available_lead_providers
        render :new, status: :unprocessable_entity
      end
    rescue ::FrameworkAgreements::SeedFromPrevious::PreviousFrameworkAgreementError,
           ::FrameworkAgreements::SeedFromPrevious::AlreadyPopulatedError => e
    ...
    def destroy
      ...
      ::FrameworkAgreements::CascadeDelete.new(framework_agreement:, author: current_user).call
      flash[:notice] = "#{lead_provider_name} removed"
      redirect_to admin_contract_period_framework_agreements_path(@contract_period)
    rescue ::FrameworkAgreements::CascadeDelete::CascadeDeleteError => e
