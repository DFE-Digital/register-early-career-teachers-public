module Admin::Finance::FrameworkAgreements
  class ContractsController < Admin::Finance::BaseController
    ...
    def index
      @breadcrumbs = {
        ...
        @framework_agreement.lead_provider_name => admin_contract_period_framework_agreements_path(@framework_agreement.contract_period),
      }
    ...
    def show
      @breadcrumbs = {
        ...
        @framework_agreement.contract_period_year.to_s => admin_contract_period_path(@framework_agreement.contract_period),
        @framework_agreement.lead_provider_name => admin_contract_period_framework_agreements_path(@framework_agreement.contract_period),
        "Contracts" => admin_contract_period_framework_agreement_contracts_path(@framework_agreement.contract_period, @framework_agreement),
      }
    end
  ...
  private
    ...
    def contract_path(contract)
      admin_contract_period_framework_agreement_contract_path(
        @framework_agreement.contract_period, @framework_agreement, contract
      )
    end

    def contracts_path
      admin_contract_period_framework_agreement_contracts_path(
