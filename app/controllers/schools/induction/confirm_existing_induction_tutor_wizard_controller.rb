class Schools::Induction::ConfirmExistingInductionTutorWizardController < SchoolsController
  before_action :initialize_wizard, only: %i[new create]
  before_action :check_allowed_step, only: %i[new create]

  WIZARD_CLASS = Schools::Induction::ConfirmExistingInductionTutorWizard::Wizard
...
private
  ...
  def initialize_wizard
    redirect_to(root_path) unless store.school_id
